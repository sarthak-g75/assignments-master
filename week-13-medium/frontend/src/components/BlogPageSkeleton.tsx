const BlogPageSkeleton = () => {
  return (
    <div>
      <div
        role='status'
        className='items-center w-full gap-2 space-y-8 lg:gap-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:flex-col'
      >
        <div className='flex flex-col w-full gap-6 lg:flex-row'>
          ...
          <div>
            <div className='w-48 h-2 mb-2 bg-gray-200 rounded-full dark:bg-gray-700 '></div>
            <div className='w-32 h-2 mb-2 bg-gray-200 rounded-full dark:bg-gray-700'></div>
            <div className='w-40 h-2 mb-2 bg-gray-200 rounded-full dark:bg-gray-700'></div>
          </div>
        </div>
